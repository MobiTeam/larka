			...
			<DocumentTitle title='Нет прав для просмотра страницы! (401)'>
				<div className="container not-found-wrapper">
					<div className="not-found-box">
						...
						<p className="not-found-info">Для просмотра данной страницы у Вас недостаточно прав.<br/> Если это произошло по ошибке, то свяжитесь с администрацией сайта - <a href="mailto:webmaster@в-форме.рф"></a></p>
						<Link to="/dashboard">
